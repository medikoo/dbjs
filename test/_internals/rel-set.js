...
module.exports = function (t, a) {
	...
	a.deep(ns2.foo.values.sort(), ['marko', 'misko'].sort(),
		"Extension: Fallback");
	a(ns2.foo.count, 0, "Extension: Fallback: Count");
	...
	a(ns2.foo.count, 0, "Extension: Fallback: Parent add: Count");
	...
	a(ns2.foo.count, 1, "Extension: Fallback: Add: Count");
	...
	a(ns2.foo.count, 1, "Extension: Fallback: Remove: Count");
	...
	a(ns3.foo.count, 0, "2nd Extension: Count");
	...
	a(ns2.foo.count, 1, "2nd Extension: Fallback: Extension: Count");
	...
	a(ns3.foo.count, 1, "2nd Extension: Fallback: Add: Count");
	...
	a(ns3.foo.count, 1, "2nd Extension: Fallback: Remove: Count");
	a(ns3.foo.has('topl'), true,
	...
	a(ns2.foo.count, 0, "2nd Extension: Fallback: Extension: Count");
	a(ns2.foo.has('marko'), true,
	...
	a(ns3.foo.count, 1, "2nd Extension: Fallback: Mid remove: Count");
	a(ns3.foo.has('topl'), true,
	...
	a(ns3.foo.count, 1, "2nd Extension: Fallback: Top multiple: Count");
	...
	a(ns3.foo.count, 1, "2nd Extension: Fallback: Set middle: Count");
	...
	a(ns3.foo.count, 1, "2nd Extension: Fallback: Mid multiple: Count");
	a(ns3.foo.has('radzio'), true,
