...
module.exports = function (t, a) {
	...
	a(ns1.foo.__count, 0, "Namespace: Own count");
	...
	a.deep(ns2.foo.values.sort(), ['raz', 'dwa', '13', 'trzy'].sort(),
		"Extension: Content");
	a(ns2.foo.__count, 4, "Extension: Own count");
	...
	a(ns1.foo.__count, 0, "Namespace: Not affected: Own count");
	a(ns1.foo.has(13), false, "Namespace: Not affected: Has");
	ns1.foo = 'misko';
	a.deep(ns1.foo.values, ['misko'], "Namespace: Reset");
	a(ns1.foo.__count, 1, "Namespace: Reset: Own count");
	...
	a.deep(ns2.foo.values.sort(), ['marko', 'misko'].sort(),
		"Extension: Fallback");
	a(ns2.foo.__count, 0, "Extension: Fallback: Own count");
	...
	a(ns2.foo.__count, 0, "Extension: Fallback: Parent add: Own count");
	...
	a(ns2.foo.__count, 1, "Extension: Fallback: Add: Own count");
	...
	a(ns2.foo.__count, 1, "Extension: Fallback: Remove: Own count");
	...
	a(ns3.foo.__count, 0, "2nd Extension: Own count");
	...
	a(ns2.foo.__count, 1, "2nd Extension: Fallback: Extension: Own count");
	...
	a(ns3.foo.__count, 1, "2nd Extension: Fallback: Add: Own count");
	...
	a(ns3.foo.__count, 1, "2nd Extension: Fallback: Remove: Own count");
	a(ns3.foo.has('topl'), true,
	...
	a(ns2.foo.__count, 0, "2nd Extension: Fallback: Extension: Own count");
	a(ns2.foo.has('marko'), true,
	...
	a(ns3.foo.__count, 1, "2nd Extension: Fallback: Mid remove: Own count");
	a(ns3.foo.has('topl'), true,
	...
	a(ns3.foo.__count, 1, "2nd Extension: Fallback: Top multiple: Own count");
	...
	a(ns3.foo.__count, 1, "2nd Extension: Fallback: Set middle: Own count");
	...
	a(ns3.foo.__count, 1, "2nd Extension: Fallback: Mid multiple: Own count");
	a(ns3.foo.has('radzio'), true,
