...
defineProperties(Relation.prototype, {
	...
	remove: d(function (value) {
		...
		if (this.propertyIsEnumerable(key)) {
			...
			if (isTopValue && this._required && (this.count === 1)) {
	...
	has: d(function (value) {
		...
		while (proto) {
			...
			if (proto.hasOwnProperty('count')) return proto.has(value);
	...
	forEach: d(function (cb/*, thisArg*/) {
		...
		while (proto) {
			...
			if (proto.hasOwnProperty('count')) keys(proto).forEach(iterate, this);
