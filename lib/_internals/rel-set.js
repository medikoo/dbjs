...
defineProperties(RelationSet.prototype, {
	...
	add: d(function (value) {
		...
		if ((ns = this.rel._ns) && (error = ns._$validate._value(value))) {
			throw error;
		}
	...
	remove: d(function (value) {
		var ns, key, isTopValue;
		if ((ns = this.rel._ns)) (value = ns._$normalize._value(value));
	...
	_reset: d(function (value) {
		...
		if ((ns = this.rel._ns)) (value = ns(value));
		key = getKey(value);
