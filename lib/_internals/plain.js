...
var validFunction = require('es5-ext/lib/Function/valid-function')
  ...
  , lastModified, define, Plain, history, iterate;

module.exports = Plain = ee(defineProperties(function () {}, {
	...
	_iterate_: d('c', iterate = function (cb, thisArg) {
...
ee(defineProperties(Plain.prototype, {
	set: d(Plain.set),
	$set: d(Plain.$set),
...
history = require('./signal').history;
