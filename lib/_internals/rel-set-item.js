...
Object.defineProperties(Item.prototype, {
	...
	lastModified: d.gs(function () {
		...
		return (data && data[0] && data[0]._stamp_) || 0;
	}),
	$setValue: d(function (value) {
		if (value) {
			...
			this.obj._onNew_(value);
			this.obj.emit('add', this._value, this);
		} else if (this._value != null) {
			value = this._value;
			this._value = null;
			defineProperty(this.obj, this._key_, d('c', this));
			this.obj._onOld_(value);
			this.obj.emit('remove', value, this);
		}
	}),
	delete: d(function () {
		var isTopValue, value;
		...
		this.obj._onOld_(value = this._value);
		this._value = null;
		signal(this);
		this.obj.emit('remove', value, this);
	})
...
Object.defineProperties(Item.prototype._order, {
	_normalize: d(Number),
