...
define = function (obj, name) {
	var get, set, rel, relName, attr, allowNS;
	...
	if ((name in obj) && obj['__' + name]) {
		...
		if (value instanceof RelTransport) {
			...
			if ((value != null) && ((typeof value !== 'function') || value._id_) &&
					!isArray(value) && !rel.ns.is(value)) {
				value = rel.ns.$construct(value);
			}
			rel.$setValue(value);
		}
	} else {
