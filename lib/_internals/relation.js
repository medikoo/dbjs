...
defineProperties(Relation.prototype, {
	...
	$set: d(function (value) {
		...
		if ((newValue !== null) &&
				((typeof newValue !== 'function') || newValue._id_)) {
			this._onNew_(newValue);
		}
	}),
...
defineProperties(Relation.prototype.__reverse, {
	...
	$set: d(function (name) {
		...
		if (name === this._value) return;
		if (this.hasOwnProperty('_value')) reverse.unset(this.obj, this._value);
	...
	validate: d(function (name) {
		...
		if (!nameRe.test(name)) {
			return new TypeError(name + " is not a valid name");
		}
		if (name in this.obj.ns.prototype) {
			return new TypeError(name + " is already taken");
		}
		return null;
	})
});

define(Relation.prototype, 'ns', {
	normalize: i,
	validate: getNull,
	_serialize_: serialize,
	coerce: i
});
...
defineProperties(Relation.prototype.__ns, {
	...
	$set: d(function (value) {
		...
		if (revName && !(revName in this._value)) reverse.set(this.obj, revName);
