...
defineProperties(Relation.prototype, {
	...
	_writeOnce: d(false),
	writeOnce: getBoolGetSet('writeOnce'),
	_unique: d(false),
	...
	value: d.gs('c', function () {
		...
		if (this._multiple) {
			if (!this.hasOwnProperty('__count')) this.__initSet();
			return this;
		}
	...
	__setValue: d(function (value) {
		...
		if (this.hasOwnProperty('__count')) {
			this.__reset(value);
			return;
		...
		if (value === undefined) {
			...
			if ((value !== null) && ((typeof value !== 'function') || value.__id)) {
		...
		if ((oldValue !== null) &&
				((typeof oldValue !== 'function') || oldValue.__id)) {
			this.__onOld(oldValue);
		}
		if ((newValue !== null) &&
				((typeof newValue !== 'function') || newValue.__id)) {
			this.__onNew(newValue);
		}
	}),
	__validateValue: d(function (original) {
		var key, error, ns = this._ns, value;
		value = ns.coerce(original);
		if (value == null) {
			return new TypeError(original + " is not valid " + ns.__id);
		}
	...
	validate: d('c', function (value) {
		var ns, error, errors;
		if (this._writeOnce && (this._value != null)) {
		...
		if ((typeof value === 'function') && !value.__id) return;
