...
ObjectList.prototype = proto = ee(Object.create(Array.prototype, extend({
	...
	liveMap: d(memoize(function (cb) {
		...
		this.on('change', function () {
			var l;
			this.forEach(function (el, i) { list[i] = cb(el); });
			l = this.length;
...
ObjectList.listMethod = function (compareFn) {
	return new ObjectList(this, callable(compareFn));
};

defineProperty(ObjectSet.prototype, 'list',
	d(memoize(ObjectList.listMethod, { method: 'list' })));
