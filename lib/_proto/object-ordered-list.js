...
module.exports = ObjectList = function (set, compareFn) {
	...
	if (set._type_ === 'namespace') {
		set.prototype.on('extend', function (ev) { list._onAdd(ev.obj); });
		set.prototype.on('reduce', function (ev) { list._onDelete(ev.obj); });
	} else {
...
ObjectList.prototype = proto = ee(Object.create(Array.prototype, extend({
	...
	return list;
}, { method: 'liveMap', length: 2 }), d.binder({
