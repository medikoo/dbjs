...
metaNames = { __$construct: true, __validateConstruction: true,
	__tags: true, __toString: true };
...
NameSet.prototype = Object.create(ParentSet.prototype, {
	...
	_onupdate: d(function (nu, old) {
		var name, key, meta, obj = (nu || old).obj;
		if (obj.obj !== this.obj) {
			if (obj.obj.obj !== this.obj) return;
			if (!metaChangers.hasOwnProperty(obj.name)) return;
			name = obj.obj.name;
			meta = true;
		} else {
			name = obj.name;
