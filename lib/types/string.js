...
module.exports = StringType = extend(Base.$$create('String'), String);
...
proto = defineProperties(extend(StringType.prototype, String.prototype), {
	$create: d(String),
...
rel = StringType._getRel_('pattern');
rel._ns.$$setValue(RegExpType);

rel = StringType._getRel_('min');
rel._ns.$$setValue(NumberType);

rel = StringType._getRel_('max');
rel._ns.$$setValue(NumberType);
