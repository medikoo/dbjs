...
module.exports = NumberType = extend(Base.$$create('Number'), Number);
...
proto = defineProperties(extend(NumberType.prototype, Number.prototype), {
...
// Properties
rel = NumberType._getRel_('min');
rel.$$setValue(-Infinity);
rel._ns.$$setValue(NumberType);
rel._required.$$setValue(true);

rel = NumberType._getRel_('max');
rel.$$setValue(Infinity);
rel._ns.$$setValue(NumberType);
rel._required.$$setValue(true);

rel = NumberType._getRel_('step');
rel._ns.$$setValue(NumberType);
