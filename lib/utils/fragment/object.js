...
ee(Object.defineProperties(Observer.prototype, extend({
	...
	onAssign: d(function (rel) {
		...
		if (!approveTop(rel, this.approve)) return;
		if (!this.approve(rel._id_)) return;
...
module.exports = function (obj, approve) {
	var root = new Multi()
	  , observer = new Observer(root, obj, getApprove(approve));
