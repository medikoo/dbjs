...
ee(Object.defineProperties(Fragment.prototype, extend(memoize(function (obj) {
	...
	fragment = new Relations(obj, this.approveRelation);
	...
	return fragment;
}, { method: 'add', refCounter: true, dispose: function (fragment) {
	...
	remove: d(function (obj) { this.add.clearRef(obj); }),
	approveRelation: d(function (rel) { return this.approve(rel, this.obj); }),
	onEventAdd: d(function (event) { this.add(event.obj); }),
	onEventRemove: d(function (event) { this.remove(event.obj); }),
