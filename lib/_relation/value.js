...
var isUniq          = require('es5-ext/array/#/is-uniq')
...
Object.defineProperties(relation, {
	value: d.gs(function () {
		...
		if ((typeof value === 'function') && !value._id_) {
			...
			value = (value == null) ? null : this.__ns.__value.normalize(value);
			return (this.Db && this.Db.valueObjectMode) ?
					getObjectValue.call(this, value) : value;
		}
	...
	validateValue: d(function (value) {
		...
		if (this.unique && ((index = this._index_))) {
			...
			if (value == null) return null; // Value is input for object constructor
			index = index.get(ns._serialize_(ns.normalize(value)));
			if (index.count && !index.has(this.obj)) {
	...
	objectValue: d.gs(function () {
		return getObjectValue.call(this, this.value);
	})
});
